...
KeyframeOptimizationParams::KeyframeOptimizationParams(
    bool align_pose,
    bool render_aligned,
    bool align_global_pose,
    bool align_local_pose,
    float theta_lr,
    float rho_lr,
    int hr_width,
    int hr_height,
    ...
    render_aligned_(render_aligned),
    align_global_pose_(align_global_pose),
    align_local_pose_(align_local_pose),
    theta_lr_(theta_lr),
    rho_lr_(rho_lr),
    hr_width_(hr_width),
    hr_height_(hr_height),
    hr_fps_(hr_fps),
    hr_fx_(hr_fx),
    hr_fy_(hr_fy),
    hr_cx_(hr_cx),
